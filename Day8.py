...
for index in range(len(a)):
    ...
    if temp[index][0] == "nop":
        temp[index][0] = "jmp"
        found, acc = check_inf_loop(temp)
    elif temp[index][0] == "jmp":
        temp[index][0] = "nop"
        found, acc = check_inf_loop(temp)
    else:
        pass
